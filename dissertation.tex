...
(ii) Nowadays, a typical standard method to treat periodic surface systems is the GGA functional PBE.
...
In principle it can be seen from the data in Table \ref{tab:geom_comp_vasp-crystal}, that both bondlengths and angles with respect to the surface normal are slightly higher with PBE from VASP than with PBE and B3LYP from CRYSTAL, although angles do not differ much.
\begin{table}[!h]
  \centering
