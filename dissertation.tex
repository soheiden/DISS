...
\\
It can also be seen as a model systems for more complex alumosilicates. Oxide rocks are omnipresent in the crust of the earth and henceforth in most geochemical processes since the times the earth's atmosphere was oxidizing in the early stages of the planetary evoluation\cite{Trail2011} which became even extensive with the rise of photosynthetic life forms\cite{Frei2009,Buick2008,Olson2006}.
