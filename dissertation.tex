...
crystal (opt) & -1.57 & 1.77 &-1.38 \\%&-1.32 \\
 ...
 \\
\todo{
calculations with B3LYP+D3\\
$\square$ compare to VASP and PBE+D3
\\
BSSE $\rightarrow$ ghosted calculations\\
didn't converge for 1-4, not possible to do this. otherwise:\\
bigger basis: Triple Zeta  with high angular momentum\\
$\square$ compare PBE+D3, B3LYP+D3\\
