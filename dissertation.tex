...
\\\\
\todo{change this subchapters according to new nomenclature?!}
...
Also the angle of the OD bond with respect to the surface is given, since vibrations which are in plane cannot be detected with SFG spectroscopy (sum frequency generation) and hence the intensity is a function of this angle.
\begin{table*}[th]
  \centering
...
In the spectra, the intensities are given by the square of the dipole moment $\mu^2$ to which it is proportional.
