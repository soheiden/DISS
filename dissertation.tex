...
\\
A characteritic of stationary points on the potential energy surface is, that the derivation with respect to all coordinates equals 0. For these points (minima and saddle points of first order) the Hessian matrix $\doubleunderline{H}$ and their eigenvalues are of interest. The elements of this Hessian are the derivation of the potential with respect to coordinates:
\begin{equation}
...
\begin{figure}[!h]
    \centering
    \subfigure[crystal]{\includegraphics[width=0.30\textwidth]{figures/al2o3-crystal.png}}
             \quad
