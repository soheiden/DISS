...
In the spectra from the dipole corrections (in z direction, $\Gamma$-point only) the intensities are given by the square of the dipole moment $\mu^2$ to which it is proportional.
...
\todo{With more layers the systems approaches the bulk and the frequency gets more to the Debye frequency, which is the...}
