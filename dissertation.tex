...
A major advantage of DFT over wave function based methods is the size: only a three dimensional system has to be considered for three spatial coordinates $n(x,y,z)$, instead of a $3N_e$-dimensional system, %weglassen? (three spatial and 1 spin coordinate, if necessary, which makes it 4N-dimensional)}
