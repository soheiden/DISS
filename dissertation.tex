...
Whenever there are atom-centered basis sets the orbitals of different atoms can overlap, so that electrons could occupy more bases, which leads to an artificial stabilization of the system.
...
Probably, the most powerful advantage of atom centerd bases is that exact exchange and hybrid methods are available as standard methods because less basis functions are required.
