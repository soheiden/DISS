...
With Hohenberg-Kohn Theorem I \todo{also mention HK II?!} the total energy $E[n]$ can be determined as:
\begin{equation}
...
\\
\todo{cite Grimme and show equation for D2/D3 corrections}

\section{Periodic Boundary Conditions}
\textit{{\color{blue} irreducible $\vec{k}$-points necessary for describing the system $\rightarrow$ reduction due to symmetry
}}
\\
