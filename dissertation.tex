...
\\
{\color{red} present results for the O-II terminated surface here!}
As a short excurs, also a ``defect site'', the O-II terminated surface, as it is called by Kurita \cite{kuri10} was calculated. Both the clean surface and the fully covered ($1\,$ML) surface were optimized and geometry optimizations were done, in order to have a comparison to the experiment.
{\color{red} Figures of structure and spectra?}
