...
It is therefore desirable to understand heterogeneous catalytic processes by learning more about the microscopic processes which take place on the surface of materials especially by computational methods because it can deliver basic understanding.
...
A test system with non-interacting electrons reflects the real system's electron density is defined and calculated.
...
\\
A disadvantage of this approach towards a realistic system is that a ``perfect'' surface with absolutely no defect sites is simulated.
