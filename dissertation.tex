...
Furthermore, higher water coverages and hydroxylated surface systemswere studied\cite{WirthJPCC2012,Wirth2014,Wirth2015}\todo{also cite Giacomo}.
\\\\
...
The adsorption energy of 1-4$^\prime$ is not listed there and is for PBE+D2 \todo{wert hinschreiben, ist es wirklich PBE+D2 oder PW91?}.
...
%\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Adsorption Energies, Vibrations and Reactions of Water on $\upalpha$-Al$_2$O$_3$(0001) with and beyond DFT-GGA}\label{crystal_calc}
...
These calculations were conducted by Dr. J. Wirth and are partially unpublished.\todo{HSE and exact tunneling streichen, später in tabelle mit den crystal rate results integieren! inklusive der dG#-Werte}}
\hspace*{-1cm}
 \begin{tabular}{l|c}
 \toprule
 Method&k [s$^{-1}$] \\
...
\item We will then, using atom centered orbital bases (AO), test the performance of PBE+D3.
...
\subsubsection{Reaction Rate}\label{crystal-rate}
