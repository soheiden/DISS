...
\\
\todo{Corresponding ``intensities'' from AIMD calcualtions are presented in section \ref{vvacf}.}
\\
...
\begin{figure}[!h]
    \centering
    \subfigure[complete spectrum]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_iCa2.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
    \subfigure[OD stretch regime]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_iCa2_ODpart.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
...
\begin{figure}[!h]
    \centering
    \subfigure[complete spectrum]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_Cb2.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
    \subfigure[OD stretch regime]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_Cb2_ODpart.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
...
\begin{figure}[!h]
    \centering
    \subfigure[complete spectrum]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_iCb2.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
    \subfigure[OD stretch regime]{\includegraphics[width=0.30\textwidth]{figures/11-20/comp_freq_iCb2_ODpart.eps}}
             \quad
             %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. (or a blank line to force the subfigure onto a new line)
...
The exact wavenumbers differ slightly for the OD regions but in general are in good agreement.
\\
\todo{compare higher coverages (2 and 4D$_2$O and 1ML), O-II termianted surface (clean and 1ML system) and symmetric slab!}
