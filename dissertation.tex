...
{\color{red} do neighbors stabilize molecular adsorption?? In Phonon paper, Eads(Cb+Cb2)=-4.57eV, sum of the two individually is -4.06eV, so there is in fact a stabilizing effect!
