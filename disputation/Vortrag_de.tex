...
\begin{frame}
 ...
 \begin{itemize}
  ...
  %\item VASP Programmpaket
 \end{itemize}
% \begin{itemize}
%  \item PBE, B3LYP mit Dispersionskorrekturen und LMP2, in AO Basis
% \end{itemize}
 \centering
...
\begin{frame}
 ...
 \begin{itemize}
 \item Stabilste adsorbierte Spezies:
\end{itemize}
\vspace{-.2cm}
 \begin{figure}
  \centering
...
\begin{frame}
 ...
 Beispieltrajektorien für molekulare Adsorption, Dissoziation
  \begin{figure}[h!]
  \centering
   \subfigure[molekulare Adsorption]{\includegraphics[width=0.35\textwidth]{figures/mol.eps}}
%    \quad
   \subfigure[1-2 Dissoziation]{\includegraphics[width=0.35\textwidth]{figures/1-2.eps}}
 %    \quad\\
   \subfigure[1-4 Dissoziation]{\includegraphics[width=0.35\textwidth]{figures/1-4.eps}}
%    \quad
   \subfigure[1-4$^\prime$ Dissoziation]{\includegraphics[width=0.35\textwidth]{figures/1-4d.eps}}
\end{figure}
