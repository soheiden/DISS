...
\begin{frame}
 ...
 \begin{figure}
  \centering
  \subfigure{\includegraphics[width=0.25\textwidth]{figures/0001_mol_top.jpg}}
  \subfigure{\includegraphics[width=0.25\textwidth]{figures/0001_1-2-diss_top.jpg}}
  \subfigure{\includegraphics[width=0.25\textwidth]{figures/0001_1-4-diss_top.jpg}}
 \end{figure}
 \pause
...
\begin{frame}
 ...
 \newline~\newline~\newline
 \centering
 \fbox{\parbox{\textwidth}{S. Heiden, D. Usvyat, P. Saalfrank, \textbf{2019}, \textit{accepted}}}
\end{frame}
...
\begin{frame}
 ...
 Example trajectories for molecular adsorption, dissociation
  \begin{figure}[h!]
  \centering
   \subfigure[molecular adsorption]{\includegraphics[width=0.35\textwidth]{figures/mol.eps}}
%    \quad
   \subfigure[1-2 dissociation]{\includegraphics[width=0.35\textwidth]{figures/1-2.eps}}
 %    \quad\\
   \subfigure[1-4 dissociation]{\includegraphics[width=0.35\textwidth]{figures/1-4.eps}}
%    \quad
   \subfigure[1-4$^\prime$ dissociation]{\includegraphics[width=0.35\textwidth]{figures/1-4d.eps}}
\end{figure}
